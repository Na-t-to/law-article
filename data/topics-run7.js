window.TOPIC_DATA = (Array.isArray(window.TOPIC_DATA) ? window.TOPIC_DATA : []).concat([
  {
    ...
    issues: [
      { id: "tob-thirty-rule", title: "どの株式取得で公開買付けが必要になるか", status: "施行済み", statusTone: "confirmed", conclusion: "30％を超える取得を中心に、市場内外の取得方法、直前の取得、適用除外を合わせて判定する。", exception: "僅少買付けその他の適用除外があり、取得割合だけで一律には決まらない。", uncertain: "複雑な連続取引・関係者取引では個別の取得構造に沿った確認が必要。", sourceIds: ["source-fsa-tob-largeholder-final-2025"] },
      { id: "tob-transaction-design", title: "改正後に買付スキームをどう設計するか", status: "実務運用中", statusTone: "watch", conclusion: "僅少買付け、並行買付け等の要件を取得目的・時期・割合と合わせ、案件開始時からスケジュールへ組み込む。", exception: "利用できる適用除外は保有割合、過去の取得、買付予定数の上限等で異なる。", uncertain: "新制度下の案件実績が蓄積することで実務慣行がさらに具体化する可能性がある。", sourceIds: ["source-fsa-tob-largeholder-final-2025"] },
      { id: "largeholder-joint-holder", title: "共同保有者・協働エンゲージメントをどう見るか", status: "解釈整理あり", statusTone: "confirmed", conclusion: "共同取得・譲渡や議決権行使の合意を確認し、協働エンゲージメント特例の要件を満たすかを具体的に見る。", exception: "一定の金融商品取引業者等による個別の権利行使ごとの合意等には共同保有から除外される枠組みがある。", uncertain: "継続的な対話・複数の合意がある場合は事実関係ごとの評価が必要。", sourceIds: ["source-fsa-tob-largeholder-final-2025", "source-fsa-largeholder-dialogue-2025"] },
      { id: "largeholder-important-proposal", title: "投資先への対話が重要提案行為等に当たるか", status: "Q&A整理あり", statusTone: "confirmed", conclusion: "提案内容と、発行者の事業活動に重大な変更・影響を及ぼす目的があるかを分けて確認する。", exception: "単に会社提案議案への反対可能性や議決権行使内容を示唆するだけで直ちに該当するとは限らない。", uncertain: "提案の態様・強制性・目的は個別事案で評価される。", sourceIds: ["source-fsa-largeholder-dialogue-2025"] },
      { id: "largeholder-derivatives", title: "デリバティブのロングポジションをどう扱うか", status: "新規律施行済み", statusTone: "watch", conclusion: "株券取得、重要提案行為、議決権行使への影響など一定の目的を伴うロングポジションでは保有者該当性を確認する。", exception: "現物決済を選べるだけで直ちに株券取得目的が認定されるわけではなく、具体的な目的を確認する。", uncertain: "目的の認定は事実関係に依存するため運用蓄積を要する。", sourceIds: ["source-fsa-tob-largeholder-final-2025", "source-fsa-largeholder-overview-2026"] },
      { id: "largeholder-reporting", title: "大量保有報告書の提出・記載をどう更新するか", status: "施行済み", statusTone: "confirmed", conclusion: "5％超の提出義務を基礎に、改正後の保有者範囲、保有目的、重要な契約等の記載を現行様式で確認する。", exception: "特例報告の適用や共同保有者の有無等により提出方法・計算が変わる。", uncertain: "2026年度の重点レビューを通じ、記載実務が具体化する可能性がある。", sourceIds: ["source-fsa-largeholder-overview-2026", "source-fsa-tob-largeholder-final-2025"] }
    ],
  ...
  },
  {
    ...
    issues: [
      { id: "display-no1-evidence", title: "No.1・満足度表示の根拠をどう確認するか", status: "公的整理あり", statusTone: "confirmed", conclusion: "比較対象、調査対象者、調査方法が適切で、表示内容と調査結果が対応しているかを広告主側で確認する。", exception: "表示文言や注記によって消費者が受ける認識が変わるため、調査の名称だけで適法性は決まらない。", uncertain: "『～したいNo.1』等の個別表示は表示全体に応じた判断が残る。", sourceIds: ["source-caa-no1-report-2024"] },
      { id: "display-advertiser-control", title: "広告主は委託先・根拠資料をどう管理するか", status: "管理体制重視", statusTone: "watch", conclusion: "広告主自身が表示根拠を確認し、表示に関する情報共有、担当者、根拠資料の保存、問題判明時の是正を運用として持つ。", exception: "必要な管理措置の具体的な程度は事業規模・表示内容・委託形態等で異なる。", uncertain: "新しい広告手法・生成AI利用等では既存の管理方法をどう適用するか継続確認が必要。", sourceIds: ["source-caa-no1-report-2024", "source-caa-stealth-guidebook-2024"] },
      { id: "display-stealth-marketing", title: "第三者投稿が事業者の表示になるのはいつか", status: "告示施行・執行あり", statusTone: "confirmed", conclusion: "投稿内容の決定への関与、依頼・指示、便益提供等の実態から事業者の表示かを見て、広告であることが一般消費者に明瞭かを確認する。", exception: "第三者が自主的な意思で投稿し、事業者の表示内容決定への関与が認められない場合は事業者の表示とはならない。", uncertain: "新しいSNS・レビュー施策では関与の評価が事実関係に依存する。", sourceIds: ["source-caa-stealth-guidebook-2024", "source-caa-stealth-first-order-2024"] }
    ],
