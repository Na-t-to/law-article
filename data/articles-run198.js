(() => {
  ...
  const additions = [
    ...
    },
    {
      ...
      status: "adopted",
      summary: "2026年10月から始まる保険料調整制度について、対象事業所が事業主負担を追加することで、標準報酬月額12.6万円以下の新規適用短時間労働者の健康保険・厚生年金保険料の本人負担を通算3年間軽減する仕組みを示す。",
      whyImportant: [
        "制度の対象事業所・対象被保険者・利用期間を公式案内から確認できる",
        "加入対象拡大に伴う手取り減少への対応を、単なる助成金ではなく保険料負担割合の運用として理解できる",
