(() => {
  ...
  window.SOURCE_DATA = (window.SOURCE_DATA || []).map((source) => {
    ...
    return {
      ...
      whyImportant: "2026年7月31日決定の重要インフラ統一基準と、9月11日に成案となった安全基準等策定ガイドラインを同じ公式入口から確認できる。統一基準から所管省庁・業界団体等の安全基準等へ具体化する経路を追う基準点。"
    };
  });
  ...
  window.ARTICLE_DATA = (window.ARTICLE_DATA || []).map((article) => {
    ...
    return {
      ...
      summary: "2026年7月31日に決定された重要インフラ統一基準に加え、国家サイバー統括室が2026年9月11日に『重要インフラのサイバーセキュリティに係る安全基準等策定ガイドライン』を成案化した公式資料。統一基準が示す分野横断の共通枠組みを、所管省庁・業界団体等が安全基準等へ落とし込む際の詳細な参照文書が確定し、2026年10月1日の運用開始に向けた上流の制度文書がそろった。",
      whyImportant: [
        "2026年9月11日に、安全基準等策定ガイドラインが8月の案から成案へ移行したことを公式資料で確認できる",
      ...
      whatChanged: "2026年9月11日に安全基準等策定ガイドラインが案から成案へ移行し、重要インフラ統一基準から所管省庁・業界団体等の安全基準等へ具体化する詳細な参照文書が確定した。"
    };
  });
  ...
  window.TOPIC_DATA = (window.TOPIC_DATA || []).map((topic) => {
    ...
    const finalFact = "2026年9月11日、国家サイバー統括室は『重要インフラのサイバーセキュリティに係る安全基準等策定ガイドライン』を成案化した。2026年7月31日決定の重要インフラ統一基準とあわせ、2026年10月1日の運用開始に向けた上流の制度文書がそろった。";
    ...
    const finalImplication = "2026年9月11日の成案を基準に、自社分野の安全基準等・業界ガイドラインの改定を追い、ガバナンス、リスク管理、サプライチェーン、監視・復旧等の既存統制との差分を確認する。";
    const finalUncertain = "安全基準等策定ガイドラインは成案となったが、各分野の安全基準等・実施計画への具体的な反映や、個々の事業者に求められる運用水準は所管分野ごとに継続確認が必要である。";
    ...
    return {
      ...
      issues: (topic.issues || []).map((issue) => issue.id === issueId
        ? {
            ...issue,
            conclusion: "重要インフラ統一基準は2026年7月31日に決定され、安全基準等策定ガイドラインは2026年9月11日に成案となった。両者を、政府施策の共通基準から所管省庁・業界団体等の分野別安全基準等へ具体化する一連の枠組みとして扱う。",
            uncertain: "上流の統一基準・ガイドラインは成案となったが、各分野の安全基準等・実施計画への反映時期・具体内容と、個々の事業者に求められる運用水準は継続確認が必要である。",
