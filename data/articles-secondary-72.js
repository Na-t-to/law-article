  ...
  window.SOURCE_DATA = addUniqueById(window.SOURCE_DATA, [
    {
      ...
      importance: "高",
      whyImportant: "2026年改正個人情報保護法について、子供・顔特徴データ・本人関与、統計作成等・委託先・漏えい等、連絡可能個人関連情報・オプトアウト・課徴金の順に基本的考え方を議論し、その後パブリックコメントへ進む当面の検討工程を公式に確認できる。",
  ...
  window.ARTICLE_DATA = addUniqueById(window.ARTICLE_DATA, [
    {
      ...
      status: "adopted",
      summary: "2026年改正個人情報保護法の施行に向け、政令・委員会規則・ガイドライン等をどの順序で具体化するかを示した個人情報保護委員会のロードマップ。9月中旬に子供・顔特徴データ・本人関与、9月下旬から10月上旬に統計作成等・委託先・漏えい等、10月中旬に連絡可能個人関連情報・オプトアウト・課徴金の基本的考え方を議論し、意見交換・事務局ヒアリングを経て条文案とパブリックコメントへ進む流れを示す。",
      whyImportant: [
        "改正法の施行日はなお確定していない一方、企業実務に直結する下位ルールの検討順序と直近の論点公開時期が具体化した",
        "子供・顔特徴データ、統計作成等・委託先、連絡可能個人関連情報・課徴金など、実装待ちの論点ごとにいつ追加情報が出るかを追跡できる",
        "委員会審議だけでなく、個人側・事業者側との意見交換と事務局ヒアリングを挟んでパブリックコメントへ進むため、碸e��ルールと検討中の考え方を混同せず追える"
      ],
      audience: ["企業法務", "プライバシー担当", "AI・データ利活用担当", "情報セキュリティ・コンプライアンス担当"],
      audienceReason: "2026年改正の施行準備について、未確定事項を先取りせず、今後公表される基本的考え方・条文案・パブリックコメントを論点別に追跡するため。",
