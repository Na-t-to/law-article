(() => {
  ...
  if (digital) {
    ...
    digital.summary = "2026年9月10日の中間とりまとめで、チャット勧誘、ダークパターン、通信販売の最終確認画面、レスキュー・点検商法などの制度見直し方向が整理された。9月16日から10月31日まで意見募集中で、現時点では成立済みルールではない。";
    digital.practicalImpacts = [
  ...
  if (consumer) {
    ...
    consumer.summary = "2026年9月10日の中間取りまとめで、判断困難状態に着目した契約離脱、継続契約の解約妨害、更新・重要変更通知、解約料、EC定型約款などの見直し方向が整理された。9月16日から10月31日まで意見募集中で、複数案が残る論点もある。";
    consumer.practicalImpacts = [
