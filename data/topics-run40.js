window.TOPIC_DATA=(Array.isArray(window.TOPIC_DATA)?window.TOPIC_DATA:[]).filter((topic)=>topic.slug!=="fair-subcontract-transactions").concat([
{
  ...
  issues:[
    ...
    {id:"toriteki-tooling-storage",title:"金型・治具等の保管費用と回収・廃棄をどう管理するか",status:"interpreted",stage:"effective",views:[{id:"toriteki-tooling-practical",label:"所有権ではなく実質管理と取引状況から保管を見直す実務",summary:"型等の所有者だけで判断せず、廃棄承認などの実質的な管理主体と、発注継続・再使用予定を確認し、返却・廃棄・有償保管のいずれにするかを受託側と協議して台帳へ反映する。",sourceIds:["source-toriteki-tooling-storage-qa"],articleIds:["article-businesslawyers-toriteki-economic-benefit-tooling-2026"]}],conclusion:"長期間発注しない等の事情がある型等を受託側に保管させる場合は、受託側と協議して保管期間に応じた費用を支払い、廃棄・回収・継続保管の扱いも協議する。",exception:"型等が受託側所有でも、廃棄に委託者の承認を要するなど委託者が事実上管理している場合は対象に含まれ得るため、所有権だけで保管費用の検討対象から外さない。",uncertain:"Q119の『1年以上発注がない』等は過去の主な違反事例の例示であり、具体的にいつから費用負担が必要かは発注状況、再使用予定、当事者の協議等を踏まえて個別に確認する。",sourceIds:["source-toriteki-tooling-storage-qa","source-jftc-nichirin-tooling-storage-2026"]},
