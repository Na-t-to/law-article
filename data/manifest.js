window.LAW_INDEX_DATA_FILES = Object.freeze({
  ...
  topics: [
    ...
    "topics-run22.js?v=2", "topics-run23.js?v=1", "topics-run24.js?v=1", "topics-run25.js?v=1", "topics-run26.js?v=1", "topics-run27.js?v=1", "topics-run28.js?v=1", "topics-run29.js?v=1", "topics-run30.js?v=1"
  ],
  sources: [
    ...
    "sources-run22.js?v=1", "sources-run23.js?v=1", "sources-run24.js?v=1", "sources-run25.js?v=1", "sources-run26.js?v=1", "sources-run27.js?v=1", "sources-run28.js?v=1", "sources-run29.js?v=1", "sources-run30.js?v=1"
  ],
  updates: [
    ...
    "updates-run23.js?v=1", "updates-run24.js?v=1", "updates-run25.js?v=1", "updates-run26.js?v=1"
  ],
  articles: [
    ...
    "articles-run22.js?v=1", "articles-run23.js?v=1", "articles-run24.js?v=1", "articles-run25.js?v=1", "articles-run26.js?v=1", "articles-run27.js?v=1", "articles-run28.js?v=1", "articles-run29.js?v=1", "articles-run30.js?v=1"
  ]
});
