(() => {
  ...
  if (!(topic.issues || []).some((issue) => issue && issue.id === "disability-employment-rate-rare-disease-individual-assessment")) {
    topic.issues = (topic.issues || []).concat([{
      id: "disability-employment-rate-rare-disease-individual-assessment",
