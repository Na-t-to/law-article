(() => {
  ...
  const articles = [
    ...
    {
      id: "article-miyake-privacy-rules-20260918",
      ...
      sourceType: "secondary",
      sourceLabel: "法律事務所・実務解説／2026年改正個人情報保護法の政令・規則案と施行準備",
      status: "adopted",
      summary: "2026年9月16日の第369回個人情報保護委員会資料を、成立・公布済みの改正法と、なお案段階の政令・委員会規則・ガイドラインに切り分けて詳細に解説する。本人同意不要例外を自明性・公の利益・法律上列挙された類型に準ずる場合という3類型から読むこと、16歳未満の子供の個人情報、顔特徴データの周知5項目・利用停止等、年齢確認やカメラ掲示・ベンダー契約の見直し、安全管理措置のゼロトラスト・MFA・特権アカウント・横展開対策・クラウド対応まで具体化する。安全管理措置ガイドライン見直しは改正法本体とは別ルートで進み、資料上は2027年4月施行を予定しているため、施行準備の時間軸も分けて管理すべきことを示す。",
      whyImportant: [
        "9月16日の一次資料を、成立済みの法律と案段階の下位ルールに分け、企業が確定事項として扱える範囲と今後変わり得る範囲を明確にしている",
        "同意例外を3類型の法的枠から整理し、政令・規則で広い救済がされる前提に立たないという解釈上の境界を示している",
        "子供・顔特徴データを、年齢確認、法定代理人対応、カメラ周知5項目、停止請求、ベンダー契約・ログ管理という実装課題へ落としている",
        "安全管理措置についてゼロトラスト、MFA、特権ID、横展開、クラウドを社内規程・自己点検へ落とす例を示し、改正法本体とは異なる2027年4月予定の準備工程を具体化している"
      ],
      audience: ["企業法務", "個人情報・プライバシー担当", "AI・データ担当", "プロダクト・UX担当", "情報セキュリティ担当"],
      audienceReason: "2026年改正法の施行準備を、成立済み法律・案段階の下位ルール・安全管理措置ガイドラインの別工程に分け、同意UI、年齢対応、顔特徴データ、契約・規程、セキュリティ実装へ落とすため。",
      ...
      legacyReformInference: false,
      whatChanged: "新着実務解説／9月16日に具体化が始まった政令・規則案を、成立済み法律との境界、同意例外の3類型、子供・顔特徴データの実装、安全管理措置の規程・運用、施行準備の時間軸まで含めて整理した。"
    }
  ];
