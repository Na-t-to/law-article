window.TOPIC_DATA = (Array.isArray(window.TOPIC_DATA) ? window.TOPIC_DATA : []).concat([
  {
    ...
    issues: [
      { id: "tob-30-percent-rule", title: "市場内取得を含む30％ルールでいつTOBが必要か", status: "施行済み", statusTone: "confirmed", conclusion: "市場内取引も含め、株券等所有割合が30％を超える取得等は原則として公開買付規制の対象になるため、取得方法だけでなく取得前後の割合と適用除外を確認する。", exception: "法令上の適用除外や僅少買付け等に該当する場合は公開買付けを要しない。", uncertain: "間接取得等の目的要件は個別事実の評価が必要。", sourceIds: ["source-fsa-tob-largeholding-final-2025"] },
      { id: "tob-de-minimis", title: "30％超保有者の少量追加取得はどこまで許されるか", status: "施行済み", statusTone: "confirmed", conclusion: "一定の条件の下、取得による所有割合の増加が0.5％未満で、原則として直前6か月に対象株券等の買付け等をしていない場合などは僅少買付け等の例外を検討できる。", exception: "公開買付け・適用除外買付け等や一連の取引の評価など、法令・Q&A上の細部を確認する必要がある。", uncertain: "複雑な取得履歴や特別関係者を介する取引では事実認定が問題になり得る。", sourceIds: ["source-fsa-tob-largeholding-final-2025"] },
      { id: "largeholding-important-proposal", title: "企業との対話はどこから重要提案行為等になるか", status: "行政整理あり", statusTone: "confirmed", conclusion: "投資先企業との対話の内容を、法令・大量保有Q&Aで整理された重要提案行為等の範囲に照らして判断する。", exception: "企業価値向上に向けた通常の対話が直ちに重要提案行為等になるわけではない。", uncertain: "個別の要求内容・具体性・意思決定への働きかけの程度で評価が変わる。", sourceIds: ["source-fsa-largeholding-dialogue-2025", "source-fsa-tob-largeholding-final-2025"] },
      { id: "largeholding-joint-holder", title: "協働エンゲージメントは共同保有に当たるか", status: "行政整理あり", statusTone: "confirmed", conclusion: "複数投資家が協働する場合でも、個別の権利行使についてどのような合意があるか等を確認し、共同保有者該当性を判断する。", exception: "中長期的な企業価値向上を目的とする意見交換や協働が当然に共同保有となるものではない。", uncertain: "合意の内容・証拠・継続性など具体的な事実関係に左右される。", sourceIds: ["source-fsa-largeholding-dialogue-2025", "source-fsa-tob-largeholding-final-2025"] },
      { id: "largeholding-derivatives", title: "現金決済型エクイティ・デリバティブをどう扱うか", status: "施行済み", statusTone: "confirmed", conclusion: "一定の要件を満たす現金決済型エクイティ・デリバティブは大量保有報告制度の対象となり得るため、権利の内容と株券等への換算方法を確認する。", exception: "すべてのデリバティブが一律に対象となるわけではなく、法令上の適用要件がある。", uncertain: "複雑なデリバティブ設計では個別検討が必要。", sourceIds: ["source-fsa-tob-largeholding-final-2025"] }
    ],
  ...
  },
  {
    ...
    issues: [
      { id: "takeover-desirable", title: "『望ましい買収』は何で判断するか", status: "Q&A明確化", statusTone: "confirmed", conclusion: "企業価値が向上し、その増加分が適正な取引条件により買収者・株主間で公正に分配され、株主共同の利益が確保されるかを見る。", exception: "高い買収価格は重要な要素だが、それだけで望ましい買収と決まるものではない。", uncertain: "企業価値向上策の評価には将来予測が含まれる。", sourceIds: ["source-meti-takeover-guideline-qa-2026"] },
      { id: "takeover-bona-fide", title: "どの提案を『真摯な買収提案』として扱うか", status: "Q&A明確化", statusTone: "confirmed", conclusion: "具体性、目的の正当性、実現可能性が合理的に疑われる事情を総合考慮し、真摯な提案か判断する。", exception: "資金裏付け不足等の例示の一つに当たるだけで直ちに真摯性が否定されるわけではない。", uncertain: "総合判断であり、提案の成熟度や交渉経緯によって評価が変わる。", sourceIds: ["source-meti-takeover-guideline-qa-2026"] },
      { id: "takeover-board-review", title: "取締役会は真摯な提案をどう検討するか", status: "Q&A明確化", statusTone: "confirmed", conclusion: "企業価値向上の観点から、買収者、取引条件、実現可能性、買収後の経営方針等を検討し、買収に応じるか代替策を選ぶか判断する。", exception: "真摯な検討後の経営判断には一定の裁量がある。", uncertain: "必要な情報量・外部専門家関与等は案件の規模・緊急性・利益相反状況に応じる。", sourceIds: ["source-meti-takeover-guideline-qa-2026"] }
    ],
  ...
  },
  {
    ...
    issues: [
      { id: "ebr-eligibility", title: "どの段階・事業者が制度を使えるか", status: "施行前・ルール確定", statusTone: "watch", conclusion: "倒産状態に至る前の経済的に窮境に陥るおそれのある事業者が、法令・Q&Aの利用要件を満たすか確認する。", exception: "事業者の状態や再生可能性等の要件を満たさない場合は利用できない。", uncertain: "制度開始後の利用判断・指定確認調査機関の運用蓄積が必要。", sourceIds: ["source-meti-early-business-recovery-rules-2026"] },
      { id: "ebr-financial-claims", title: "どの債権・担保が多数決の対象になるか", status: "施行前・ルール確定", statusTone: "watch", conclusion: "対象となる金融機関等・貸付債権等と、担保でカバーされる部分などの扱いを施行規則・Q&Aで確認する。", exception: "取引債権・租税債権などは制度の対象外であり、金融債権でも対象範囲の確認が必要。", uncertain: "担保価値や対象債権額の評価が争点となる案件では実務調整が必要。", sourceIds: ["source-meti-early-business-recovery-rules-2026"] },
      { id: "ebr-voting-court", title: "多数決と裁判所認可で何が変わるか", status: "施行前・ルール確定", statusTone: "watch", conclusion: "全員同意がない場合でも、原則として総議決権額の4分の3以上の賛成等と裁判所認可により権利変更を成立させ得る。", exception: "多数決だけで自動的に成立するのではなく、裁判所認可等の法定手続が必要。", uncertain: "認可判断や異議・不服申立てを含む実務は施行後の蓄積を要する。", sourceIds: ["source-meti-early-business-recovery-rules-2026"] },
      { id: "ebr-process", title: "従来の私的整理・法的整理とどう使い分けるか", status: "実務形成前", statusTone: "watch", conclusion: "全員同意の見込み、事業価値毀損リスク、対象債権、時間、必要なスポンサー・資金等を踏まえ、従来型私的整理、早期事業再生法、法的整理を比較する。", exception: "全員同意が現実的な案件では従来の私的整理が適する場合もある。", uncertain: "施行後の利用事例により典型的な選択場面が形成される。", sourceIds: ["source-meti-early-business-recovery-rules-2026"] }
    ],
