window.TOPIC_DATA=(Array.isArray(window.TOPIC_DATA)?window.TOPIC_DATA:[]).concat([
{
  ...
  summary:"2026年7月に成立・公布された個人情報保護法改正について、子供の個人情報、同意取得の例外、特定生体個人情報、委託、課徴金を中心に、施行前の準備事項と未確定の下位ルールを整理する。",
  lastUpdated:"2026-09-04",
  lastVerified:"2026-09-04",
  isNew:true,
  overview:[
    "2026年改正は、データ利活用を広げる規律と、子供・生体情報・委託・不適正利用・エンフォースメントを強化する規律を一つの改正で扱う。AI開発だけに限らず、BtoCサービス、カメラ、委託・クラウド、データ提供、コンプライアンス全般に影響する。",
  ...
  currentSummary:{
    facts:[
      ...
      "主な改正には、16歳未満の子供の個人情報等に関する規律、同意取得の例外拡張、特定生体個人情報に関する規律、委託先に関する規律、課徴金制度の創設が含まれる。"
    ],
    interpretations:[
      "改正対応はプライバシーポリシーの改訂だけでは足りず、年齢確認・同意取得画面、カメラ等の周知、本人請求受付、委託契約・再委託、データ提供先の確認、違反時の調査記録まで業務フロー単位で棚卸しする必要がある。",
    ...
    uncertain:[
      "特定生体個人情報の具体的範囲、子供の個人情報に関する『必要な措置』、同意不要例外の具体類型、委託先規律の適用要件、課徴金の算定・適用除外等は、今後の政令・規則・ガイドライン・Q&Aの整備を継続確認する必要がある。",
  ...
  practicalImpacts:["プライバシーポリシー・通知","年齢確認・法定代理人同意","同意取得フロー","顔認証・AIカメラ等の周知","本人請求対応","委託契約・再委託管理","データ提供先DD・契約","課徴金リスク管理・記録","施行準備・下位ルール追跡"]
}
]);
