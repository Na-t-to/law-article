(() => {
  ...
  const topic = {
    ...
    overview: [
      ...
      "同時に、新たに加入対象となる短時間労働者の就業調整を抑えるため、一定の事業所が事業主の保険料負担割合を一時的に引き上げて本人負担を軽減し、その追加負担相当額は原則として納付後に還付される保険料調整制度が2026年10月から始まります。人事・給与・従業員説明を一体で準備する必要があります。"
    ],
    currentSummary: {
      facts: [
        ...
        "保険料調整制度は2026年10月から開始し、対象事業所の標準報酬月額12.6万円以下の対象短時間労働者について、事業主の負担割合を一時的に引き上げて本人負担を通算3年間軽減する。事業主が追加負担した相当額は、原則として納付後に還付される。"
      ],
      interpretations: [
        ...
        "保険料調整制度は事業主の申出と一時的な負担割合変更・還付処理を伴う時限措置であり、対象となる事業所・被保険者・利用期間を通常の社会保険加入判定と分けて管理した方がよい。"
      ],
      implications: [
        ...
        "保険料調整制度を利用する場合は、対象事業所・対象者、標準報酬月額、申出期限、本人負担と事業主負担の割合、追加負担相当額の還付を給与計算と従業員説明資料へ反映する。",
    ...
    issues: [
      ...
      },
      {
        ...
        stage: "enacted",
        views: [],
        conclusion: "2026年10月以降、一定の対象事業所は、標準報酬月額12.6万円以下の対象短時間労働者について、事業主の負担割合を一時的に引き上げて本人負担を通算3年間軽減する保険料調整制度を利用できる。事業主が追加負担した相当額は原則として納付後に還付される。",
